...
const founders = [
  {
    ...
    bio: 'Executive leadership in R&D projects; 30+ experience in DNA biotechnology and single-molecule detection.',
    expertise: ['DNA Nanotechnology', 'Single-Molecule Detection', 'R&D Leadership'],
    initials: 'PZ',
    photo: '/images/founder-peiming-zhang.jpg',
    accentColor: '#0066FF',
    gradientFrom: '#003DB5',
    gradientTo: '#0077FF',
  },
  {
    ...
    bio: 'Director of the Biodesign Center for Bioelectronics & Biosensors at ASU; pioneering expertise in nanoelectronics.',
